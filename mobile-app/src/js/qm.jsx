    ...
    return (
      <div>
        <div className="header">
          <h2>Quine McCluskey</h2>
          Bits: <input type="text" ref="bits" className="form-control" placeholder="A,B,C" />
          <br />
          <button type="button" className="btn btn-default btn-block" onClick={this.addFunction}>Aggiungi Funzione</button>
        </div>
        <div className="body">
          <div>
            {this.state.func}
